...
{
    public abstract class BloggsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BloggsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BloggsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BloggsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BloggsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BloggsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BloggsDbContext, Task<T>> func)
        {
            T result;
